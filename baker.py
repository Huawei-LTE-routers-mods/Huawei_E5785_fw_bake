...
SYSTEM_FILES = [
    ...
    ("xbin/speedtest", 0, 0, ATTR_IS_FILE | 0o755),
    ...
    ("etc/ssl", 0, 0, ATTR_IS_DIR | 0o755),
    ("etc/ssl/cert.pem", 0, 0, ATTR_IS_FILE | 0o755),
...
APP_FILES = [
    ...
    ("hijack/scripts/fix_cell.sh", 1000, 1000, ATTR_IS_FILE | 0o775),
